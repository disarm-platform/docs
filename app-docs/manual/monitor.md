...
When the user clicks download the application will pop up a message "retrieving more records" as shown in the image below:![](https://github.com/disarm-platform/docs/tree/9243c194dc2bba011d6f92dd9634f7ff8989d8fa/app-docs/.gitbook/assets/app-image101.png)
...
When plans have been created the selector will have the text "select plan" and once clicked on it will display the plan names so the user can choose one as shown below;![](https://github.com/disarm-platform/docs/tree/9243c194dc2bba011d6f92dd9634f7ff8989d8fa/app-docs/.gitbook/assets/app-image112.png)
...
The option to select "guess locations" is used to add GPS coordinates for records that are missing the GPS coordinates. Sometimes the application administrator will set the collection of GPS coordinates optional so that if the device does not manage to collect GPS coordinates when offline the user still manages to record that they sprayed somewhere.![](https://github.com/disarm-platform/docs/tree/9243c194dc2bba011d6f92dd9634f7ff8989d8fa/app-docs/.gitbook/assets/app-image31.png)height="2.0416666666666665in"}
...
If there are records that have loaded on the map, they will appear as dots located on the map.![](https://github.com/disarm-platform/docs/tree/9243c194dc2bba011d6f92dd9634f7ff8989d8fa/app-docs/.gitbook/assets/app-image106.png)

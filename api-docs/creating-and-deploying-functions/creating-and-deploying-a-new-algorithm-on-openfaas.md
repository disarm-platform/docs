...
2. Change at least these files:
   * `stack.yml`: this describes the Docker image, and the name the function will have when deployed \(don't want to over-write an existing algo\) (see [editing stack.yml](/api-docs/creating-and-deploying-functions/editing-stack-yml))
